...
@Component({
  selector: 'app-work-ex-timeline-entry-dot',
  templateUrl: './work-ex-timeline-entry-dot.component.html',
  styleUrls: ['./work-ex-timeline-entry-dot.component.scss']
})
export class WorkExTimelineEntryDotComponent implements AfterViewInit {
  ...
  private getCollapsedStyle() {
    return {
      top: '50%',
      left: (this.isAlternate) ? '-5px' : 'calc(100% + 5px)',
      width: this.size + 'px',
      height: this.size + 'px',
      opacity: 1,
