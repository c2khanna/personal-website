...
@Component({
  selector: 'app-work-ex-timeline-entry-content',
  templateUrl: './work-ex-timeline-entry-content.component.html',
  styleUrls: ['./work-ex-timeline-entry-content.component.scss']
})
export class WorkExTimelineEntryContentComponent implements AfterViewInit {
